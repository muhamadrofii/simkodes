...
Route::get('/outgoingletters', [IncomingLetterController::class, 'index'])->name('outgoingletters.index');
Route::get('/outgoingletters/create', [IncomingLetterController::class, 'create'])->name('outgoingletters.create');
Route::post('/outgoingletters', [IncomingLetterController::class, 'store'])->name('outgoingletters.store');
Route::get('/outgoingletters/{id}', [IncomingLetterController::class, 'show'])->name('outgoingletters.show');
Route::get('/outgoingletters/{id}/edit', [IncomingLetterController::class, 'edit'])->name('outgoingletters.edit');
Route::put('/outgoingletters/{id}', [IncomingLetterController::class, 'update'])->name('outgoingletters.update');
Route::delete('/outgoingletters/{id}', [IncomingLetterController::class, 'destroy'])->name('outgoingletters.destroy');
