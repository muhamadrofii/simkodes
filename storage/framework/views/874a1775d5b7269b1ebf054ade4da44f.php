...
<?php endif; ?>
<?php $component->withAttributes([]); ?>Add Incoming Letter <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
    ...
    <div class="bg-white rounded-4 shadow-sm p-4 mb-5">
        <form action="<?php echo e(route('incomingletters.store')); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-4">
                ...
                <input type="text" 
                       name="ref_number" 
                       id="ref_number" 
                       class="form-control <?php $__errorArgs = ['ref_number'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="d-flex justify-content-between align-items-center mt-5">
                <a href="<?php echo e(route('incomingletters.index')); ?>" class="btn btn-outline-secondary">
...
<?php endif; ?>
<?php /**PATH C:\3.BUWONO\Dokumen\kuliah\SEMESTER 7\KKN\proker\aplikasi-pengelolaan-data-member\aplikasi-pengelolaan-data-member\resources\views/letters/incoming/create.blade.php ENDPATH**/ ?>