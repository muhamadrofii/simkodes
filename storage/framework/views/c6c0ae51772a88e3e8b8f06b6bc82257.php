...
<?php endif; ?>
<?php $component->withAttributes([]); ?>Data Anggota <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
    ...
    <div class="bg-white rounded-4 shadow-sm p-4 mb-5">
        <div class="row">
            <div class="d-grid d-lg-block col-lg-5 col-xl-6 mb-4 mb-lg-0">
                ...
                <a href="<?php echo e(route('members.create')); ?>" class="btn btn-primary btn-action-icon">
                    <i class="ti ti-plus me-2"></i> Tambah Data Anggota
                </a>
            </div>
            <div class="col-lg-7 col-xl-6">
                
                <form action="<?php echo e(route('members.index')); ?>" method="GET">
                    <div class="input-group">
                        <input type="text" name="search" class="form-control form-search" 
                               value="<?php echo e(request('search')); ?>" placeholder="Cari nama anggota ..." autocomplete="off">
        ...
        <?php $__empty_1 = true; $__currentLoopData = $members; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $member): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            ...
            <div class="col-lg-6 col-xl-3">
                <div class="bg-white rounded-4 shadow-sm text-center p-4 mb-4">
                    ...
                    <h6><?php echo e($member->nama); ?></h6>
                    <p class="text-muted mb-4">
                        Jenis: <?php echo e($member->category->name ?? 'Tidak Ada Kategori'); ?>
...
<?php endif; ?>
<?php /**PATH C:\3.BUWONO\Dokumen\kuliah\SEMESTER 7\KKN\proker\aplikasi-pengelolaan-data-member\aplikasi-pengelolaan-data-member\resources\views/members/index.blade.php ENDPATH**/ ?>