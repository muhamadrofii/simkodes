...
<?php endif; ?>
<?php $component->withAttributes([]); ?>Data Pengawas <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
    ...
    <div class="bg-white rounded-4 shadow-sm p-4 mb-5">
        <div class="row">
            <div class="d-grid d-lg-block col-lg-5 col-xl-6 mb-4 mb-lg-0">
                ...
                <a href="<?php echo e(route('supervisors.create')); ?>" class="btn btn-primary btn-action-icon">
                ...
                <form action="<?php echo e(route('supervisors.index')); ?>" method="GET">
                    <div class="input-group">
                        <input type="text" name="search" class="form-control form-search" 
                               value="<?php echo e(request('search')); ?>" placeholder="Cari nama pengawas ..." autocomplete="off">
        ...
        <?php $__empty_1 = true; $__currentLoopData = $supervisors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $supervisor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            ...
            <div class="col-lg-6 col-xl-3">
                <div class="bg-white rounded-4 shadow-sm text-center p-4 mb-4">
                    ...
                    <h6><?php echo e($supervisor->nama); ?></h6>
                    
                    <p class="text-muted mb-4">
                        Kategori: <?php echo e($supervisor->category->name ?? 'Tidak Ada Kategori'); ?>

                    </p>

                    
                    <a href="<?php echo e(route('supervisors.show', $supervisor->id)); ?>" 
        ...
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
            ...
            <div class="col">
                <div class="alert alert-primary rounded-4 d-flex align-items-center" role="alert">
                    ...
                    <div>Tidak Ada Data Pengawas.</div>
                </div>
            </div>
        <?php endif; ?>
    </div>
...
<?php endif; ?>
<?php /**PATH C:\3.BUWONO\Dokumen\kuliah\SEMESTER 7\KKN\proker\aplikasi-pengelolaan-data-member\aplikasi-pengelolaan-data-member\resources\views/supervisors/index.blade.php ENDPATH**/ ?>