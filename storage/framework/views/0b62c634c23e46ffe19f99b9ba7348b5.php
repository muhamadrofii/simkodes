    ...
    <div class="kta">
        ...
        <div class="content">
            ...
            <table class="data">
                ...
                <tr><td>Jabatan</td><td>:</td><td><?php echo e($supervisor->jabatan ?? 'Supervisor'); ?></td></tr>
                <tr><td>Mata Pencaharian</td><td>:</td><td><?php echo e($supervisor->mata_pencaharian ?? '-'); ?></td></tr>
                <tr><td>Alamat</td><td>:</td><td><?php echo e($supervisor->tempat_tinggal ?? '-'); ?></td></tr>
                <tr><td>Tanggal Dipilih</td><td>:</td><td><?php echo e($supervisor->tanggal_dipilih ? date('d F Y', strtotime($supervisor->tanggal_dipilih)) : '-'); ?></td></tr>
            </table>
        </div>
        ...
        <div class="photo">
            <?php if($photoBase64): ?>
                <img src="<?php echo e($photoBase64); ?>" alt="Foto Supervisor">
            <?php else: ?>
                Foto<br>Tidak Ada
            <?php endif; ?>
        </div>
...
<?php /**PATH C:\3.BUWONO\Dokumen\kuliah\SEMESTER 7\KKN\proker\aplikasi-pengelolaan-data-member\aplikasi-pengelolaan-data-member\resources\views/supervisors/kta.blade.php ENDPATH**/ ?>