<x-app-layout>
    {{-- Page Title --}}
    <x-page-title>Incoming Letter Details</x-page-title>
    ...
    <div class="bg-white rounded-4 shadow-sm p-4 mb-5">
        ...
        <div class="pt-4 border-top mt-4 d-flex justify-content-between">
            <a href="{{ route('incomingletters.index') }}" class="btn btn-secondary">
                ← Back
            </a>
            <div class="d-flex gap-2">
                <a href="{{ route('incomingletters.edit', $letter->id) }}" class="btn btn-warning">
