    ...
    <div class="bg-white rounded-4 shadow-sm p-4 mb-4">
        <div class="row align-items-center justify-content-between g-3">
            ...
            <div class="col-md-6 col-lg-5">
                <a href="{{ route('outgoingletters.create') }}" class="btn btn-primary d-flex align-items-center justify-content-center justify-content-md-start w-100 w-md-auto">
            ...
            <div class="col-md-6 col-lg-7">
                <form action="{{ route('outgoingletters.index') }}" method="GET" class="d-flex">
                    <input type="text" name="search" class="form-control rounded-start"
                        value="{{ request('search') }}" placeholder="Cari surat keluar..." autocomplete="off">
        ...
        <div class="table-responsive">
            <table class="table table-hover align-middle">
                ...
                <tbody class="border-top-0">
                    @forelse ($outgoingletters as $key => $letter)
                        <tr>
                            <td class="text-center text-muted">
                                {{ ($outgoingletters->currentPage() - 1) * $outgoingletters->perPage() + $key + 1 }}
                            </td>
                            <td>
                            ...
                            <td>
                                <span class="badge bg-warning-subtle text-warning border border-warning-subtle px-3 py-2 rounded-3">
                                    {{ $letter->category ?? 'Umum' }}
                                </span>
                            </td>
                            <td class="text-center">
                                @if($letter->file)
                                    <a href="{{ asset('outgoing_letters/' . $letter->file) }}" target="_blank" class="btn btn-light btn-sm rounded-3 border p-2" title="Unduh Berkas Asli">
                            ...
                            <td>
                                <div class="d-flex justify-content-center gap-2">
                                    ...
                                    {{-- Full Details --}}
                                    <a href="{{ route('outgoingletters.show', $letter->id) }}"
                                    ...
                                    {{-- Edit --}}
                                    <a href="{{ route('outgoingletters.edit', $letter->id) }}"
                                    ...
                                    <div class="modal-dialog modal-lg modal-dialog-centered">
                                        <div class="modal-content rounded-4 border-0 shadow">
                                            <div class="modal-header border-0 pb-0">
                                                <h5 class="modal-title fw-bold">Pratinjau Surat Keluar</h5>
                                            ...
                                            <div class="modal-body p-4">
                                                <div class="row g-3 mb-4">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <p class="mb-0">
                                                            @if($letter->file)
                                                                <a href="{{ asset('outgoing_letters/' . $letter->file) }}" target="_blank" class="text-decoration-none small">
                                            ...
                                            <div class="modal-footer border-0 pt-0">
                                                ...
                                                <a href="{{ route('outgoingletters.show', $letter->id) }}" class="btn btn-primary">Informasi Lengkap</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content rounded-4 border-0 shadow">
                                            ...
                                            <div class="modal-body py-4 text-center">
                                                ...
                                                <p class="mb-0">Yakin ingin menghapus surat keluar
