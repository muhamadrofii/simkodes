<x-app-layout>
    {{-- Page Title --}}
    <x-page-title>Tambah Surat Keluar</x-page-title>

    {{-- Form Card --}}
    <div class="bg-white rounded-4 shadow-sm p-4 mb-5">
        <form action="{{ route('outgoingletters.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            {{-- Reference Number --}}
            <div class="mb-4">
                <label for="reference_number" class="form-label fw-semibold">No. Surat</label>
                <input type="text" 
            ...
            <div class="d-flex justify-content-between align-items-center mt-5">
                <a href="{{ route('outgoingletters.index') }}" class="btn btn-outline-secondary">
