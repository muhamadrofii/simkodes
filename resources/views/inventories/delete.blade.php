<x-app-layout>
    <x-page-title>Hapus Barang Inventaris</x-page-title>
    ...
    <div class="bg-white rounded-4 shadow-sm p-4">
        ...
        <table class="table table-bordered align-middle">
            ...
            <tr>
                <th>Total Harga</th>
                <td>Rp {{ number_format($inventory->jumlah_rupiah, 0, ',', '.') }}</td>
            </tr>
            <tr>
                <th>Umur Teknis</th>
                <td>{{ $inventory->umur_teknis }}</td>
            </tr>
            <tr>
                <th>Umur Ekonomis</th>
                <td>{{ $inventory->umur_ekonomis }}</td>
            </tr>
            <tr>
                <th>Keterangan</th>
