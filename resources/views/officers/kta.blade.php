...
<head>
    <meta charset="UTF-8">
    <title>KTA Officer Premium</title>
    <style>
        @page {
            size: A5 landscape;
            margin: 0;
    ...
    <table class="container" border="0" cellspacing="0" cellpadding="0">
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        ...
                        <td align="center" style="vertical-align: middle;">
                            <div class="title-main" style="font-size: 24px; font-weight: 900; text-transform: uppercase; margin: 0; letter-spacing: 1px; color: #b71c1c;">KARTU TANDA PENGURUS</div>
        ...
        <tr>
            <td class="content-area">
                <div class="name-tag">{{ strtoupper($officer->nama) }}</div>
                <table class="data-table" width="100%">
                    <tr>
                        <td class="label">ID PENGURUS</td>
                        <td class="value">OFF-{{ str_pad($officer->id, 5, '0', STR_PAD_LEFT) }}</td>
                    </tr>
                    <tr>
                        <td class="label">JABATAN</td>
                        <td class="value">{{ strtoupper($officer->jabatan ?? 'PENGURUS') }}</td>
                    </tr>
                    <tr>
                        <td class="label">JENIS KELAMIN</td>
                        <td class="value">{{ $officer->jenis_kelamin == 'L' ? 'LAKI-LAKI' : 'PEREMPUAN' }}</td>
                    </tr>
                    <tr>
                        <td class="label">ALAMAT</td>
                        <td class="value">{{ strtoupper($officer->tempat_tinggal ?? '-') }}</td>
                    </tr>
                </table>
            </td>
        ...
        <tr>
            <td colspan="2" class="footer-cell">
                Kartu ini merupakan identitas resmi Pengurus Koperasi Merah Putih Desa Sranak. Segala wewenang diatur
