    ...
    <div class="kta">
        ...
        <div class="content">
            ...
            <table class="data">
                ...
                <tr><td>Jabatan</td><td>:</td><td>{{ $officer->mata_pencaharian ?? 'Pengurus' }}</td></tr>
                <tr><td>Alamat</td><td>:</td><td>{{ $officer->tempat_tinggal ?? '-' }}</td></tr>
                <tr><td>Tanggal Masuk</td><td>:</td><td>{{ $officer->tanggal_masuk ? date('d F Y', strtotime($officer->tanggal_masuk)) : '-' }}</td></tr>
            </table>
        </div>
        ...
        <div class="photo">
            @if ($photoBase64)
                <img src="{{ $photoBase64 }}" alt="Foto Officer">
            @else
                Foto<br>Tidak Ada
            @endif
        </div>
