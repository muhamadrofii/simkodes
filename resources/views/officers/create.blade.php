<x-app-layout>
    {{-- Page Title --}}
    <x-page-title>Tambah Pengurus</x-page-title>
        ...
        <form action="{{ route('officers.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-xl-6">
                    <div class="mb-3 ps-xl-3">
                        ...
                        <input type="date" name="tanggal_diangkat" class="form-control @error('tanggal_diangkat') is-invalid @enderror" value="{{ old('tanggal_diangkat') }}">
            ...
            <div class="pt-4 pb-2 mt-5 border-top">
                <div class="d-grid gap-3 d-sm-flex justify-content-md-start pt-1">
                    ...
                    <a href="{{ route('officers.index') }}" class="btn btn-secondary btn-action">Batal</a>
                </div>
            </div>
        </form>
    </div>
