<x-app-layout>
    {{-- Page Title --}}
    <x-page-title>Tambah Pengawas</x-page-title>
        ...
        <form action="{{ route('supervisors.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-xl-6">
                    <div class="mb-3 ps-xl-3">
                        ...
                        <input type="date" name="tanggal_dipilih" class="form-control @error('tanggal_dipilih') is-invalid @enderror" value="{{ old('tanggal_dipilih') }}">
            ...
            <div class="row">
                <div class="col-xl-6">
                    ...
                    <div class="mb-3 pe-xl-3">
                        ...
                        <input type="text" name="no_anggota_koperasi" class="form-control @error('no_anggota_koperasi') is-invalid @enderror" value="{{ old('no_anggota_koperasi') }}">
                ...
                <div class="col-xl-6">
                    ...
                    <div class="mb-3 ps-xl-3">
                        ...
                        <input type="date" name="tanggal_berhenti" class="form-control @error('tanggal_berhenti') is-invalid @enderror" value="{{ old('tanggal_berhenti') }}">
            ...
            <div class="pt-4 pb-2 mt-5 border-top">
                <div class="d-grid gap-3 d-sm-flex justify-content-md-start pt-1">
                    ...
                    <a href="{{ route('supervisors.index') }}" class="btn btn-secondary btn-action">Batal</a>
                </div>
            </div>
        </form>
    </div>
